 ...
 * @author Karen
 */
public class BarcosAmotor extends Barcos {
    ...
    public BarcosAmotor(int potenciaEnCV) {
        this.potenciaEnCV = potenciaEnCV;
    }

    public BarcosAmotor(int potenciaEnCV, int matricula, int anioFabricacion, double eslora) {
